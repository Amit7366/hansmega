    ...
    return (
        <div className="home-bg-2 position-relative min-h-full">
            ...
            <div className="code-card position-absolute text-center" style={{ left: '50%', transform: 'translateX(-50%)' }}>
                ...
                <p>
                    Know each other and enjoy <span style={{ color: '#00AC47' }}>private</span>, <span style={{ color: '#00AC47' }}>secure</span> and <span style={{ color: '#00AC47' }}>hasslefree</span> live moment with your dating partner
                </p>
                <h1 className='duotitle2' style={{ color: '#00AC47' }}>Login with Megapersonals</h1>
                <form onSubmit={handleSubmit(handleAddBooking)} className='login-frm'>
                    <input style={{ borderColor: '#00AC47' }} type="text" {...register("email", { required: true })} placeholder='Email Address' className='input-from' />
                    <input style={{ borderColor: '#00AC47' }} type="password" {...register("password", { required: true })} placeholder='Password' className='input-from' />
                    <button className='dubtn' style={{ backgroundColor: '#00AC47' }}>Login</button>
                </form>
