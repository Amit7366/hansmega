    ...
    return (
        <div className="home-bg-2 position-relative min-h-full">
            ...
            <div className="code-card position-absolute text-center" style={{ left: '50%', transform: 'translateX(-50%)' }}>
                ...
                <p>
                    Know each other and enjoy <span style={{ color: '#22C55E' }}>private</span>, <span style={{ color: '#22C55E' }}>secure</span> and <span style={{ color: '#22C55E' }}>hasslefree</span> live moment with your dating partner
                </p>
                <h1 className='duotitle2' style={{ color: '#22C55E' }}>Login with Megapersonals</h1>
                <form onSubmit={handleSubmit(handleAddBooking)} className='login-frm'>
                    <input style={{ borderColor: '#22C55E' }} type="text" {...register("email", { required: true })} placeholder='Email Address' className='input-from' />
                    <input style={{ borderColor: '#22C55E' }} type="password" {...register("password", { required: true })} placeholder='Password' className='input-from' />
                    <button className='dubtn' style={{ backgroundColor: '#22C55E' }}>Login</button>
                </form>
